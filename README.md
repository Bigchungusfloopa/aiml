...
Numbers, tables and confusion matrices are in **[REPORT.md](REPORT.md)** /
[`docs/results.md`](docs/results.md) (regenerated by `python -m aitext.report`).
Trained on MAGE, 8,000 samples/class, stratified 80/20 split.
